...
public class InternalDeliveryService : IInternalDeliveryService
{
    ...
    {
        Console.WriteLine("DeliverOrder " + orderId);
    }
...
public class Program
{
    ...
    {
        IInternalDeliveryService deliveryService = new InternalDeliveryService();
        deliveryService.DeliverOrder("12345");
        string status = deliveryService.GetDeliveryStatus("12345");
